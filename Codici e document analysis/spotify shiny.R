...
ui <- fluidPage(theme = shinytheme("cerulean"),
  navbarPage("", # Con navbarPage posso aggiungere diverse pagine, in modo da dividere per argomenti
    ...
    tabPanel("1.c Descrizione delle variabili",
             mainPanel(h1("Variabili dataset"),
                       ...
                       h3("Danceability"),
                       print("Quanto una traccia è adeguata ad essere ballata, basandosi su una combinazione di elementi musicali che includono tempo, stabilità del ritmo, potenza dei beat e regolarità complessiva. 0 non ballabile, mentre 1 è il valore massimo"),
                       h3("Energy"),
  ...
  tabPanel("4.b Conclusioni finali",
           div(style="text-align:center",h1("Conclusioni finali:"),br(),br(),br(),br(),br(), h4("- Risultati soddisfacenti dal punto di vista previsivo"),h4("- Possibilità di utilizzare l'analisi con uno scopo differente da quello presentato", h4("- Applicazione shiny facile da utilizzare e funzionale allo scopo")))
  ))
           )
))
